/**
 * Display mirror of backend/src/lib/phone.ts — normalizes a raw phone string
 * to E.164. Accepts international "+…" input for any country; bare numbers are
 * assumed Indian mobiles (10 digits starting 6-9, optionally 0- or
 * 91-prefixed). Returns null when the input can't be a deliverable number.
 */
