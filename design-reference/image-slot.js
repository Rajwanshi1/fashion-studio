 ...
 *
 * NOTE (imported reference): this is the Claude Design canvas editing component.
 * In the production React app we only replicate its VISUAL empty-state
 * (celadon gradient + uppercase label, styled via brand.css `image-slot` rules)
 * and render real <img> elements when a product image URL exists.
 * The drag/drop/reframe machinery below is design-tool-only.
 */
/* END USAGE */
