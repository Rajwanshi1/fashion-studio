...
function BrandIcon({ d }: { d: string }) {
  return (
    <svg viewBox="0 0 24 24" width="1em" height="1em" fill="currentColor" aria-hidden="true" style={ICON_STYLE}>
      <path d={d} />
    </svg>
  );
}
...
const LINK_ICONS: Record<string, React.ReactNode> = {
  ...
  instagram: <BrandIcon d={INSTAGRAM_PATH} />,
  whatsapp: <BrandIcon d={WHATSAPP_PATH} />,
  call: (
    <StrokeIcon>
